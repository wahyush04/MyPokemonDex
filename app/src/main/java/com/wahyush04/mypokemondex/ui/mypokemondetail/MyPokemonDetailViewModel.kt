...
class MyPokemonDetailViewModel (application: Application): AndroidViewModel(application) {
    ...
    init {
        ...
        repository = MyPokemonRepository(application)
    }
    ...
    fun deletePoke(pokeEntity: PokeEntity){
        viewModelScope.launch(Dispatchers.IO){
            repository.deletePokemon(pokeEntity)
        }
    }
